...
def load_features(features_path: str = 'features.csv') -> pd.DataFrame:
    """
...
def train_model(
    ...
    X_val, y_val, w_val = prepare_data(val_df, feature_cols)
    ...
    train_data = lgb.Dataset(
        ...
        categorical_feature=['map_name'] if 'map_name' in train_df.columns else None
    )
    ...
    val_data = lgb.Dataset(
        ...
        weight=w_val,
        feature_name=feature_cols,
        categorical_feature=['map_name'] if 'map_name' in val_df.columns else None,
