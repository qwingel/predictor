...
def rolling_weighted_mean(
    ...
    Args:
        ...
        date_col: имя колонки с датами (datetime или строка YYYY-MM-DD)
        value_col: имя колонки со значениями
        weight_col: имя колонки с весами (если None, используется step_weight)
        target_date: дата, относительно которой считаем "прошлое"
        step_weights: использовать ли ступенчатые веса
